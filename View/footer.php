<?php
/*
    Description: Dungeons Footer imported on every page.
...
<footer class="relative-bottom page-footer font-small pt-4 text-light bg-dark">
    ...
    <div class="footer-copyright text-center py-3">
      ...
      <a href="#" onclick="document.cookie='cookiebar=;expires=Thu, 01 Jan 1970 00:00:01 GMT;path=/'; setupCookieBar(); return false;">Revoke Cookie Consent</a>
    </div>
    <!-- Copyright -->
</footer>
